...
if(isset($_SESSION['idu']))
{
	...
	try 
	{
		...
		<p> A combien de question voulez-vous répondre ? </p></center>
		<div class="container">
		  <form action="aleatoire.php" method="post">
			<div class="form-group">
				<label for="nbquestions">Nombre de question(s) :</label>
				<input type="number" class="form-control" id="nbquestions" placeholder="Nb question(s)" name="nbquestions" pattern="^(?=.*[0-9]){1,}$" required>
			  </div>
